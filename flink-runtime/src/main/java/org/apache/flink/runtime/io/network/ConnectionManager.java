...
/**
 * NetworkEnvironment 中通过 ConnectionManager 来管理所有的网络的连接 NettyConnectionManager 就是 ConnectionManager
 * 的具体实现。
 *
 * <p>The connection manager manages physical connections for the (logical) remote input channels at
 * runtime.
 */
