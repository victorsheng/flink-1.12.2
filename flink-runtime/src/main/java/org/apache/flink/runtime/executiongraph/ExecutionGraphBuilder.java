...
public class ExecutionGraphBuilder {
    ...
    public static ExecutionGraph buildGraph(
        ...
        //    Configuration jobManagerConfig : {internal.jobgraph-path=job.graph,
        ...
        //    SlotProvider slotProvider :
        //    ClassLoader classLoader :
        // org.apache.flink.runtime.execution.librarycache.FlinkUserCodeClassLoaders$SafetyNetWrapperClassLoader@747f7a53
        ...
        try {
            ...
            // {"jid":"6f62d20b6ab55d63983db42b98be9e50","name":"Socket Window
        ...
        //        {JobVertexID@7361} "6d2677a0ecc3fd8df0b72ec675edf8f4" -> {JobVertex@7313} "Sink:
        // Print to Std. Out (org.apache.flink.streaming.runtime.tasks.OneInputStreamTask)"
        //        {JobVertexID@7362} "ea632d67b7d595e5b851708ae9ad79d6" -> {JobVertex@7363}
        // "Window(TumblingProcessingTimeWindows(5000), ProcessingTimeTrigger, ReduceFunction$1,
        // PassThroughWindowFunction) (org.apache.flink.streaming.runtime.tasks.OneInputStreamTask)"
        //        {JobVertexID@7364} "0a448493b4782967b150582570326227" -> {JobVertex@7365} "Flat
        // Map (org.apache.flink.streaming.runtime.tasks.OneInputStreamTask)"
        //        {JobVertexID@7366} "bc764cd8ddf7a0cff126f51c16239658" -> {JobVertex@7367} "Source:
        // Socket Stream (org.apache.flink.streaming.runtime.tasks.SourceStreamTask)"
        ...
        //    0 = {JobVertex@7480} "Source: Socket Stream
        // (org.apache.flink.streaming.runtime.tasks.SourceStreamTask)"
        //    1 = {JobVertex@7459} "Flat Map
        // (org.apache.flink.streaming.runtime.tasks.OneInputStreamTask)"
        //    2 = {JobVertex@7448} "Window(TumblingProcessingTimeWindows(5000),
        // ProcessingTimeTrigger, ReduceFunction$1, PassThroughWindowFunction)
        // (org.apache.flink.streaming.runtime.tasks.OneInputStreamTask)"
        //    3 = {JobVertex@7426} "Sink: Print to Std. Out
        // (org.apache.flink.streaming.runtime.tasks.OneInputStreamTask)"
