 ...
 *
 * <p>Wrapper around an {@link Output} for user functions that expect a {@link Output}.
 *
 * <p>在将{@link TimestampedCollector}赋予 user function 之前， 必须设置应该附加到已发出元素的时间戳。
 *
 * <p>Before giving the {@link TimestampedCollector} to a user function you must set the timestamp
 * that should be attached to emitted elements.
 *
 * <p>大多数操作符都会设置传入消息的时间戳 {@link org.apache.flink.streaming.runtime.streamrecord.StreamRecord} here.
 *
 * <p>Most operators would set the timestamp of the incoming {@link
